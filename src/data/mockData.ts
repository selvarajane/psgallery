...
export const products: Product[] = [
  ...
  { id: '17', name: '24x36 inches', price: 2499, image: 'https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcSy7LR4IdzK8R_Wmp4uum_q6JFmKlU89Fm4iLKEoJPWHDg7wzI4yI5wCCyn2YuAOpXh_Dvc4xNCybbUP96elCH03lN0qN7blvXElDWYshtC_RfBNKtjACKC', description: 'Movie poster size frame', category: 'xlarge', courierCharge: 350, material: 'Wooden Frame', dimensions: '24" x 36"', weight: '1800g' },
  { id: '18', name: 'A4 Size', price: 300, image: 'https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTzWqQib2Z_WhwuWW8UmoETEDDnzzJ_XVvhoWfFw3zWMIiRCEU-rftwVxikMFloYjrXP1xMOIco6d8hc3oTDgPL5M82ZqRipg', description: 'Standard document frame (8.3x11.7")', category: 'standard', courierCharge: 60, material: 'Wooden Frame', dimensions: '8.3" x 11.7"', weight: '300g' },
  { id: '19', name: 'A3 Size', price: 600, image: 'https://littleotja.com/cdn/shop/files/Little-Otja-Okvir-lesen-hrast_otroska-like-fotografije.jpg?v=1708886050', description: 'Large document frame (11.7x16.5")', category: 'standard', courierCharge: 120, material: 'Wooden Frame', dimensions: '11.7" x 16.5"', weight: '600g' },
  ...
  { id: '24', name: 'Collage 4-Photo', price: 499, image: 'https://artstreet.in/cdn/shop/products/PMPWT15034.1_700x700.jpg?v=1685337653', description: '4 openings for multiple photos', category: 'collage', courierCharge: 150, material: 'Wooden Frame', dimensions: '12" x 16"', weight: '800g' },
  { id: '25', name: 'Collage 6-Photo', price: 599, image: 'https://www.photoland.in/wp-content/uploads/2021/12/photo-frame_set-of-6-Best-Wishes-d2-c-1-600x600.jpg', description: '6 openings for family collage', category: 'collage', courierCharge: 180, material: 'Wooden Frame', dimensions: '16" x 20"', weight: '950g' },
  { id: '26', name: 'Collage 8-Photo', price: 799, image: 'https://www.ecraftindia.com/cdn/shop/products/CPFS210_BLK_main_hd.jpg?v=1638373050', description: '8 openings for memory wall', category: 'collage', courierCharge: 220, material: 'Wooden Frame', dimensions: '20" x 24"', weight: '1100g' },
  ...
  { id: '28', name: 'Certificate Frame', price: 450, image: 'https://m.media-amazon.com/images/I/81Ry6mwN1iL._AC_UF894,1000_QL80_.jpg', description: 'Professional certificate display', category: 'certificate', courierCharge: 90, material: 'Wooden Frame', dimensions: '8" x 10"', weight: '450g' },
